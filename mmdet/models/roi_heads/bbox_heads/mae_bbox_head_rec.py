...
class MAEBoxHeadRec(BBoxHead):
    ...
    def forward(self, x, img=None):
        ...
        img_rec   = self.fc_rec(x[:, 1:, :]).transpose(1,2).reshape(B, -1, W, H) if self.with_reconstruct else None
        return cls_score, bbox_pred, img_rec
    ...
    def loss(self,
        ...
        if cls_score is not None:
            ...
            if cls_score.numel() > 0:
                losses['loss_cls'] = self.loss_cls(
                    ...
                    reduction_override=reduction_override) * self.loss_weight_bbox_start
        ...
        if bbox_pred is not None:
            ...
            if pos_inds.any():
                ...
                losses['loss_bbox'] = bbox_pred[pos_inds].sum() * self.loss_weight_bbox_start
        ## rec_loss
        if recs is not None:
            ...
            losses['loss_rec'] = loss_rec * self.rec_weight
        return losses
