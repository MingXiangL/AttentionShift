...
#             pseudo_gt_scores.append(pseudo_scores)
    ...
    def get_mask_sample_points(self, coords, attn, cls_points, pos_thr=0.1, neg_thr=0.01, num_gt=10):
        ...
        coords_chosen = torch.stack(coord_chosen)
    ...
    def seed_pseudo_gt(self,
        ...
        print(f'pos_mask_thr: {pos_mask_thr}, neg_mask_thr: {neg_mask_thr}, num_mask_point_gt: {num_mask_point_gt}')
...
#                     scale_cam = cv2.resize(scale_cam, (patch_w * 16, patch_h * 16))
        ...
        if return_mask:
            ...
            for i_img in range(num_imgs):
                coord_point, labels_point = self.get_mask_sample_points(coords_map, attn_maps_dealed[i_img], gt_labels[i_img], pos_thr=pos_mask_thr, neg_thr=neg_mask_thr, num_gt=num_mask_point_gt)
