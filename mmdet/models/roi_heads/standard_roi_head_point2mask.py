...
class StandardRoIHeadPoint2Mask(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
...
#                     scale_cam = cv2.resize(scale_cam, (patch_w * 16, patch_h * 16))
        ...
        if return_mask:
            ...
            return gt_labels, mil_out[0], mil_out[1], pseudo_gt_mask, ignore_mask, points_attn_maps_per_img
        else:
...
#             losses.update(bbox_results['loss_bbox_rec'])
        ...
        if self.with_mask:
            ...
            mask_results = self._mask_forward_train(x, sampling_results,
                                                    ...
                                                    gt_masks, img_metas, ignore_mask=weight)
